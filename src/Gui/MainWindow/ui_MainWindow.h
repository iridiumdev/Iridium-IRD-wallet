...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/iridium"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutIridiumAction = new QAction(MainWindow);
        m_aboutIridiumAction->setObjectName(QStringLiteral("m_aboutIridiumAction"));
        m_aboutIridiumAction->setEnabled(true);
...
//        menuHelp->addAction(m_reportIssueAction);
        ...
        QObject::connect(m_aboutIridiumAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutIridiumAction->setText(QApplication::translate("MainWindow", "About Iridium", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND IRIDIUM", Q_NULLPTR));
