...
public:
    ...
    void retranslateUi(QFrame *PrivacyFrame)
    {
        ...
        m_newsCheck->setText(QApplication::translate("PrivacyFrame", "I want to see Iridium Blog feeds", 0));
        m_embeddedHelperLabel->setText(QApplication::translate("PrivacyFrame", "Checking this box will result in updated Overview screen. It will now show you the latest posts of Iridium Blog providing you with fresh iridium news.", 0));
    } // retranslateUi
